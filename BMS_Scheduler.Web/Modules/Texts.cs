    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your BMS_Scheduler Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your BMS_Scheduler Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "BMS_Scheduler";
        }
        ...
        public static partial class Validation
        {
            ...
            public static LocalText UsernameAndPasswordRequired = "Username and Password Required";
        }

        public static partial class Controls
        {
            public static LocalText View = "Preview";
            ...
            public static class IdleTimeout
            {
                ...
                public static LocalText SignoutButton = "Logout";
