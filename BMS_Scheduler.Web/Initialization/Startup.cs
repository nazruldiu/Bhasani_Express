using BMS_Scheduler.Administration;
using BMS_Scheduler.AppServices;
...
namespace BMS_Scheduler
{
    public partial class Startup
    {
        public Startup(IConfiguration configuration, IWebHostEnvironment hostEnvironment)
        {
            ...
            AppStatics.InitilizeConfigurations(configuration, hostEnvironment);
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<BackgroundTaskSettings>(Configuration.GetSection(BackgroundTaskSettings.SectionKey));
            ...
            services.AddSingleton<IPermissionService>(services =>
                    new TransientGrantingPermissionService(
                        new LogicOperatorPermissionService(ActivatorUtilities.CreateInstance<PermissionService>(services)),
                    services.GetService<IHttpContextItemsAccessor>()));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //var backgroundTaskManager = app.ApplicationServices.GetRequiredService<IBackgroundTaskManager>();
            //backgroundTaskManager.Register(ActivatorUtilities.CreateInstance<MailingBackgroundTask>(app.ApplicationServices));
