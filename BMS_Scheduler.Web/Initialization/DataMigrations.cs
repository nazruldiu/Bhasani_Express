    ...
    public class DataMigrations : IDataMigrations
    {
        ...
        public void Initialize()
        {
            foreach (var databaseKey in databaseKeys)
            {
                ...
                //if (databaseKey == "Default") { RunMigrations(databaseKey); }
            }
        }
        ...
        private void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want BMS_Scheduler migrations to run on your DB.
            ...
            var migrationNamespace = "BMS_Scheduler.Migrations." + databaseKey + "DB";
